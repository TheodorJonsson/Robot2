...
public class RandomRobot
{
    ...
    {
        if((maze.isMovable(position.getPosToSouth())) && (!previousPosition.equals(position.getPosToSouth())))
        {
            return false;
        }
        if((maze.isMovable(position.getPosToEast())) && (!previousPosition.equals(position.getPosToEast())))
        {
            return false;
        }
        if((maze.isMovable(position.getPosToNorth())) && (!previousPosition.equals(position.getPosToNorth())))
        {
            return false;
        }
        if((maze.isMovable(position.getPosToWest())) && (!previousPosition.equals(position.getPosToWest())))
        {
            return false;
        }
        return true;
